...
const FIXTURE = JSON.parse(
  readFileSync(
    path.join(__dirname, "fixtures", "joaoborn-junction-ground-truth.json"),
    "utf8",
  ),
);
...
// EVERY GT arm and NONE of the forbiddenArms phantom targets. João Born is LINEAR
// (D-14): junctions {} makes these per-junction loops no-ops — the route-agnostic
// structure is asserted (zero junctions, no phantom incident).
