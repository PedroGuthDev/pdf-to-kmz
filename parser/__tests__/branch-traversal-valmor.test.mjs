...
const FIXTURE = JSON.parse(
  readFileSync(
    path.join(__dirname, "fixtures", "valmor-junction-ground-truth.json"),
    "utf8",
  ),
);
...
// EVERY GT arm and NONE of the forbiddenArms phantom targets. Valmor is DRAFTED
// near-linear (D-13): junctions {} makes these per-junction loops no-ops pending
// user confirmation of any real junctions.
